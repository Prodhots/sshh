...
def Membuat_ssl(id, cookies, user, pw, server):
	...
	head = {"Host":"https://sshstores.net","Connection":"keep-alive","Accept":"*/*","Origin":"https://sshstores.net","X-Requested-With":"XMLHttpRequest","User-Agent":acak,"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","Referer":server,"Accept-Encoding":"gzip, deflate","Accept-Language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
...
def Membuat_ssh(id, cookies, user, pw, server):
	...
	acak = random.choice(agent.split("\n"))
	head = {"Host":"https://sshstores.net","Connection":"keep-alive","Accept":"*/*","Origin":"https://sshstores.net","X-Requested-With":"XMLHttpRequest","User-Agent":acak,"Content-Type":"application/x-www-form-urlencoded; charset=UTF-8","Referer":server,"Accept-Encoding":"gzip, deflate","Accept-Language":"id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7"}
	posd = post("https://sshstores.net/ssh-server-7-days.php", headers=head, data=data, cookies={"PHPSESSID":cookies}).text
	if "Your Account has been successfully created !" in posd:
		print("  \x1b[1;91m>>> \x1b[1;97mACCOUNT \x1b[1;92mBERHASIL \x1b[1;97mDIBUAT")
		print("  \x1b[1;91m> \x1b[1;97mUSERNAME \x1b[1;91m:\x1b[1;92m "+re.search("Username\s\s:\s(.*?)<br>", str(posd)).group(1))
		print("  \x1b[1;91m> \x1b[1;97mPASSWORD \x1b[1;91m:\x1b[1;92m "+re.search("Password\s\s:\s(.*?)<br>", str(posd)).group(1))
...
class SSH:
	...
	def Chek(self):
		self.cek = par(get("https://sshstores.net/ssh-ssl-server").text, "html.parser")
		for one in self.cek.find_all("div", attrs={"class":"plan-hp"}):
